      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="relative order-1 md:order-2">
            <div className="rounded-xl md:rounded-2xl overflow-hidden hover-lift">
              <img
                src={aboutImg}
          ...
          <div className="order-2 md:order-1">
            <h2 className="font-display font-extrabold text-3xl md:text-7xl text-primary mb-4 md:mb-8">About</h2>
